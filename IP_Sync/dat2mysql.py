...
def db2mysql(mysql_object,ipv6_tablename,db_filename):
    ...
    i = 0
    j = 0
    insert_sql = 'INSERT  INTO `'+ ipv6_tablename +'` (`ip_start`, `ip_start_num`, `ip_end`, `ip_end_num`, `country`, `province`, `city`, `area`, `address`, `location`, `UpdateTime`) VALUES ( %s, _binary %s, _binary %s, %s, %s, %s, %s, %s, %s, %s, DEFAULT )'
    for info in D.iter():
        if info.info[0]:
